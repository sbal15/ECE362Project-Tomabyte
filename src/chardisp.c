...
//Can only draw uppercase letters for now as we have only dfined uppercase letters here
...
// Example 16x16 character sprite (yellow face with black eyes and mouth)
...
// void animate_bounce() {
//     int sprite_y = 30;       // starting vertical position
//     int bounce_dir = 1;      // 1 = down, -1 = up
//     while (true) {
//         oled_fill(0x0000); // clear screen

//         // Draw sprite at current position
//         oled_draw_sprite_scaled(56, sprite_y, pet_sprite, 16, 16, 4);

//         // Update position
//         sprite_y += bounce_dir;

//         // Reverse direction at bounds
//         if (sprite_y >= 80 || sprite_y <= 20) {
//             bounce_dir *= -1;
//         }

//         sleep_ms(50); // control speed
//     }
// }
